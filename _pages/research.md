...
<h4 class="research-title">Provided but not perceived? Dyadic discrepancies in emotional support perception and mental health in adolescent peer networks</h4>
<h4 class="research-title"><a href="https://osf.io/afdp6/" target="_blank" rel="noopener noreferrer">Provided but not perceived? Dyadic discrepancies in emotional support perception and mental health in adolescent peer networks</a></h4>
<p class="research-desc">This study investigates discrepancies in the perception and provision of emotional support among adolescents, with a focus on mental health, loneliness, and gender as potential predictors of distorted perceptions. Using sociocentric network data from two school-based surveys in Germany (N = 3072, age 13–14) and Scotland (N = 303, age 12-13 and 14–15), we analysed mismatches between self-reported emotional support provision and perceived emotional support receipt using quadratic assignment procedure (QAP) models. Across both samples, substantial mismatches in support perception and provision were observed. Boys were more likely to perceive support that was not acknowledged by alleged senders, and same-gender dyads exhibited fewer discrepancies. While psychological distress and loneliness demonstrated limited explanatory power, the Scottish sample revealed associations between higher levels of psychological distress and failures to perceive reported support. Differences in how adolescents reported responding to peers emotionally were associated with whether support was mutually recognized.</p>
</div>
</div>
